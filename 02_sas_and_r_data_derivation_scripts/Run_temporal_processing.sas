...
%let setStudyID =  6;  %let gapCT = 45; %let inName = temporal_data_SA_Gansbaai_kelp.csv; %import_check_process; *%include 'C:\work - analysis\NCEAS Kelp\Unified_temporal\check_errors_and_process.sas' /lrecl=100000; 
...
%let setStudyID =  14; %let gapCT = 45; %let inName = temporal_data_isla_natividad.csv; %import_check_process; *%include 'C:\work - analysis\NCEAS Kelp\Unified_temporal\check_errors_and_process.sas' /lrecl=100000; 
